...
DATABASES = {
    'default': {
        ...
        'NAME': 'lifewebsitestagedb',
        'USER': 'lifeadmin',
        'PASSWORD': 'Z!]Z%}G:X4e_!Fh_',
        'HOST': 'life-website-stage-ub18-rds-dbinstance.csolxarqbqg2.eu-west-2.rds.amazonaws.com',
        'PORT': '5432',
        'CONN_MAX_AGE': 600,
    }
}
...
AWS_S3_CUSTOM_DOMAIN = 'd2smomaftmigml.cloudfront.net'
