...
# REAPIT_CLIENT_ID = '67lliul8dl5hp2giprabg2922v'
# REAPIT_URL = 'https://developers.reapit.cloud/swagger'
# REAPIT_WSDL = https://connect.reapit.cloud/authorize?response_type=code&client_id=<REAPIT_CLIENT_ID>&redirect_uri=<REAPIT_URL>
